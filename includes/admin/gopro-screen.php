<?php
$test = esc_url ( plugins_url( 'media/choose-bundle.png', __FILE__ ) );
?>

<div class="container-pricing">
    <h2>CHOOSE THE BEST PLAN FOR YOU</h2>
    <p class="bundle-picture"><img src="<?php echo esc_url ( plugins_url( 'media/choose-bundle.png', __FILE__ ) ); ?>" alt="Bundle Choose"></p>
    <h3>What are you waiting for? Join our premium membership community of online business owners who build, grow and scale together, with our bundle.</h3>
    <div class="price-row">
        <div class="tkgf-price-col tkgf-pro-plan">
            <p class="bundle-type">Pro Version</p>
            <h4><span id='tkgf-savings-price-pro'>$119.97</span> <span>/year</span></h4>
            <h5>BLOCKED WITH THE FREE VERSION? UNLOCK ALL PRO FEATURES.</h5>
            <h3><span class="fs-bundle-currency">$</span><span class="tkgf-fs-pro-price">39.99</span> /year</h3>
            <select id="tkgf-pro-license">
            ...
            <button id="tkgf-purchase-pro-plan">GET NOW</button>
        </div>
        <div class="tkgf-price-col tkgf-memebership-bundle">
            <p class="bundle-type">TK Membership</p>
            <h4><span id='tkgf-savings-price-bundle'>$602.75</span> <span>/year</span></h4>
            <h5>PREMIUM PACK WITH ALL OUR PRODUCTS INCLUDED.</h5>
            <h3><span class="fs-bundle-currency">$</span><span class="tkgf-fs-bundle-price">99.99</span> /year</h3>
            <select id="tkgf-membership-license">
                <option value="1" selected="selected">Single Site License</option>
                <option value="5">5-Site License</option>
                <option value="unlimited">Unlimited Sites License</option>
            </select>
            <div class="list-bundle-ul tkgf-show-more">
                <ul>
            ...
            <button class="tkgf-bundle-list-see-more">See more</button>
            <button id="tkgf-purchase-bundle-plan">GET NOW</button>
        </div>
    </div>
</div>
